...
if( !class_exists( 'ReduxFramework_custom_header_builder' ) ) {
    ...
    class ReduxFramework_custom_header_builder{
        ...
        public function render() {
           ...
           foreach ( $temp as $k => $v ) {
            ...
            if ( $sortlists ) {
                ...
                foreach ( $sortlists as $group => $sortlist ) {
                    ...
                    <div id="wgl_modal_builder_items" style="display:none;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2><?php
                                echo apply_filters( "wgl-changed-text-modal-window-{$this->parent->args['opt_name']}", __( 'WGL Select Item', 'irecco-core' ) );
                                ?></h2>
                            </div>
                        ...
                        echo '<div class="wgl_header_row-btn">';
                            ...
                            echo '<div class="wgl_header_row-toggle"><a href="#" title="'.apply_filters("wgl-toggle-row-text", __( 'Toggle row', 'irecco-core' )).'"><i class="wgl_arrow"></i></a></div>';
                            
                            echo '<div class="wgl_header_row-disabled"><a href="#" title="'.apply_filters("wgl-disabled-row-text", __( 'Disabled row', 'irecco-core' )).'"><i class="fa fa-desktop"></i></a>';
                            ...
                            echo '<div class="wgl_header_row-opt" data-section-opt="'.$row_opt_id.'"><a href="#" title="'.apply_filters("wgl-edit-row-text", __( 'Edit this row', 'irecco-core' )).'"><i class="fa fa-pencil"></i></a></div>';
                        echo '</div>';
                    }
                    ...
                    if($index != 0){
                        ...
                        */                   
                        ...
                        echo '<span class="edit_column" data-opt-col-id="'.esc_attr($column_opt_id).'"><a href="#" title="'.apply_filters("wgl-edit-column-text", __( 'Edit this column', 'irecco-core' )).'"><i class="fa fa-pencil" aria-hidden="true"></i></a></span>';
                        
                        echo '<span class="add_item"><a href="#" title="'.apply_filters("wgl-add-item", __( 'Add Item', 'irecco-core' )).'"><i class="fa fa-plus" aria-hidden="true"></i></a></span>';
                    }
                ...
                echo '</fieldset>';
                echo '<div class="overlay_header" style="display: none;"><h2><a href="#irecco_set-opt-js-preset">'.esc_html__('Select preset for start editing', 'irecco-core').'</a></h2></div>';                
                // Modal Options items
                ?>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <span class="close close-btn"><?php
                                echo apply_filters( "wgl-close-text-modal-window-{$this->parent->args['opt_name']}", __( 'Save Changes', 'irecco-core' ) );
                            ?></span>
                            <h2><?php
                            echo apply_filters( "wgl-changed-text-modal-window-{$this->parent->args['opt_name']}", __( 'WGL Header Options', 'irecco-core' ) );
                            ?></h2>
                        </div>
                        <div class="modal-body">
                        </div>
        ...
        public function enqueue() {
            ...
            $vars = array(
                'delete'   => __( 'Are you sure want to delete the element?', 'irecco-core' ),
            );
