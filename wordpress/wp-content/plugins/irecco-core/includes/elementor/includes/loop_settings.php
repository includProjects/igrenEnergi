	...
	class Wgl_Loop_Settings
	{
		...
		public static function init($self, $atts = [])
		{
			...
			$self->start_controls_section(
				'query_section',
				[
					'label' => esc_html__( 'Query', 'irecco-core' ),
			...
			$self->add_control(
				'number_of_posts',
				[
					'label' => esc_html__( 'Post count', 'irecco-core' ),
			...
			$self->add_control(
				'order_by',
				[
					'label' => esc_html__( 'Order by', 'irecco-core' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'date',
					'options' => [
						'date' => esc_html__( 'Date', 'irecco-core' ),
						'title' => esc_html__( 'Title', 'irecco-core' ),
						'author' => esc_html__( 'Author', 'irecco-core' ),
						'modified' => esc_html__( 'Modified', 'irecco-core' ),
						'rand' => esc_html__( 'Random', 'irecco-core' ),
						'comment_count' => esc_html__( 'Comments', 'irecco-core' ),
						'menu_order' => esc_html__( 'Menu Order', 'irecco-core' ),
					],
				]
			);
			...
			$self->add_control(
				'order',
				[
					'label' => esc_html__( 'Order', 'irecco-core' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'DESC' => esc_html__( 'Descending', 'irecco-core' ),
						'ASC' => esc_html__( 'Ascending', 'irecco-core' ),
					],
					'default' => 'DESC',
				]
			);
			...
			if (! isset($atts['hide_cats'])) {
				...
				$self->add_control(
					'categories',
					[
						'label' => esc_html__( 'Filter By Category Slug', 'irecco-core' ),
				...
				$self->add_control(
					'exclude_categories',
					[
						'label' => esc_html__( 'Exclude These Categories', 'irecco-core' ),
						'type' => Controls_Manager::SWITCHER,
						'description' => esc_html__( 'Leave empty for all', 'irecco-core' ),
					]
				);  
			}           
			...
			if (! isset($atts['hide_tags']) ) :
				...
				$self->add_control(
					'tags',
					[
						'label' => esc_html__( 'Filter By Tags Slug', 'irecco-core' ),
						'type' => Controls_Manager::SELECT2,
						'multiple' => true,
						'label_block' => true,
				...
				$self->add_control(
					'exclude_tags',
					[
						'label' => esc_html__( 'Exclude These Tags', 'irecco-core' ),
						'type' => Controls_Manager::SWITCHER,
						'description' => esc_html__( 'Leave empty for all', 'irecco-core' ),
					]
				);
			...
			$self->add_control(
				'taxonomies',
				[
					'label' => esc_html__( 'Taxonomies', 'irecco-core' ),
					'type' => Controls_Manager::SELECT2, 
					'multiple' => true,
					'label_block' => true,
			...
			$self->add_control(
				'exclude_taxonomies',
				[
					'label' => esc_html__( 'Exclude These Taxonomies', 'irecco-core' ),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'On', 'irecco-core' ),
					'label_off' => esc_html__( 'Off', 'irecco-core' ),
					'description' => esc_html__( 'Filter output by custom taxonomies categories, enter category names here.', 'irecco-core' ),
				]
			);
			...
			if (! isset($atts['hide_individual_posts'])) {
				...
				$self->add_control(
					'by_posts',
					[
						'label' => esc_html__( 'Individual Posts/Pages/Custom Post Types', 'irecco-core' ),
						'type' => Controls_Manager::SELECT2,
						'multiple' => true,
						'label_block' => true,
				...
				$self->add_control(
					'exclude_any',
					[
						'label' => esc_html__( 'Exclude These Posts/Pages/Custom Post Types', 'irecco-core' ),
						'type' => Controls_Manager::SWITCHER,
						'description' => esc_html__( 'Individual Posts/Pages/Custom Post Types', 'irecco-core' ),
					]
				);
			}
			...
			$self->add_control(
				'author',
				[
					'label' => esc_html__( 'Author', 'irecco-core' ),
					'type' => Controls_Manager::SELECT2,
					'multiple' => true,
					'label_block' => true,
			...
			$self->add_control(
				'exclude_author',
				[
					'label' => esc_html__( 'Exclude Author', 'irecco-core' ),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'On', 'irecco-core' ),
					'label_off' => esc_html__( 'Off', 'irecco-core' ),
					'description' => esc_html__( 'Filter by author name', 'irecco-core' ),
				]
			);
		...
		public static function categories_suggester() {
			...
			foreach (get_categories() as $cat) {
				...
				$content[(string) $cat->slug] = $cat->cat_name.(! empty($parent) ? esc_html__( ' (Parent categories: (', 'irecco-core') .$parent.'))' : "");
			}
		...
		public static function taxonomies_suggester($atts)
		{
			...
			foreach ($result as $tag) {
				...
				$content[ $tag->taxonomy.":".$tag->slug ] = $tag->name . ' (' . $tag->taxonomy . ')' . (! empty($parent) ? esc_html__( ' (Parent categories: (', 'irecco-core') . $parent . '))' : '');
			}
			return $content;
		}
