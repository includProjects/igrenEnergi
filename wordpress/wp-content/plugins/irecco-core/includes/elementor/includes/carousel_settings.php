	...
	class Wgl_Carousel_Settings
	{
		...
		public static function options($self, $array = [])
		{
			...
			$self->add_control(
				'use_carousel',
				[
					'label' => esc_html__('Use Carousel','irecco-core' ),
			...
			$self->add_control(
				'slides_to_scroll',
				[
					'label' => esc_html__('Slide per single item at a time','irecco-core' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [ 'use_carousel' => 'yes' ],
					'label_on' => esc_html__( 'On', 'irecco-core' ),
					'label_off' => esc_html__( 'Off', 'irecco-core' ),
			...
			$self->add_control(
				'prev_next_position',
				[
					'label' => esc_html__('Arrows Positioning', 'irecco-core'),
					'type' => Controls_Manager::SELECT,
					'condition' => [ 'use_prev_next' => 'yes' ],
					'options' => [
						'' => esc_html__('Opposite each other', 'irecco-core'),
						'right' => esc_html__('Bottom right corner', 'irecco-core'),
					],
				]
			);
			...
			$self->add_control(
				...
				[
					'label' => esc_html__('Customize Arrows Colors','irecco-core' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [ 'use_prev_next' => 'yes' ],
					'label_on' => esc_html__( 'On', 'irecco-core' ),
					'label_off' => esc_html__( 'Off', 'irecco-core' ),
			...
			$self->add_control(
				'prev_next_color',
				[
					'label' => esc_html__( 'Arrows Color', 'irecco-core' ),
					'type' =>  Controls_Manager::COLOR,
					'condition' => [ 'custom_prev_next_color' => 'yes' ],
					'dynamic' => [ 'active' => true ],
					'default' => '#ffffff',
			...
			$self->add_control(
				'prev_next_bg_idle',
				[
					'label' => esc_html__( 'Arrows Background Color', 'irecco-core' ),
					'type' =>  Controls_Manager::COLOR,
					'condition' => [ 'custom_prev_next_color' => 'yes' ],
                    'default' => $theme_color,
				]
			...
			$self->add_control(
				'prev_next_bg_hover',
				[
					'label' => esc_html__( 'Arrows Background', 'irecco-core' ),
					'type' =>  Controls_Manager::COLOR,
					'condition' => [ 'custom_prev_next_color' => 'yes' ],
                    'default' => '#ffffff',
				]
		...
		public static function init($atts, $item = [], $templates = false)
		{
			...
			if ($custom_pag_color || $custom_prev_next_color || ! empty($pag_offset) || ! empty($prev_next_offset)) {
				$carousel_id = uniqid( "irecco_carousel_" );
			}
