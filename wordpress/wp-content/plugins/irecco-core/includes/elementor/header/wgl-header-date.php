...
class Wgl_Header_Date extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Current Date', 'irecco-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Date Settings', 'irecco-core'),
            ]
        );
        ...
        $this->add_control(
            'date_format_select',
            [
                'label' => esc_html__('Date Format', 'irecco-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__('Default', 'irecco-core'),
                    'wordpress_format' => esc_html__('Wordpress Format', 'irecco-core'),
        ...
        $this->add_control(
            'date_format_custom',
            [
                'label' => esc_html__('Custom Date Format', 'irecco-core'),
                ...
                'description' => __( 'Set your date format, about this, please refer to the ', 'irecco-core') . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://wordpress.org/support/article/formatting-date-and-time/', __( 'Wordpress.org', 'irecco-core') ),
            ]
        );         
        ...
        $this->add_control(
            'time_zone',
            [
                'label' => esc_html__('Time Zone', 'irecco-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'UTC' => esc_html__('Default', 'irecco-core'),
        ...
        $this->add_control(
            'date_color',
            [ 
                'label' => esc_html__('Text Idle', 'irecco-core'),
    ...
    public function render(){
        ...
        echo '<div class="wgl-header-date'.esc_attr($class_date).'">';
            echo \iRecco_Theme_Helper::render_html( $date->format( $date_format ) );
        echo '</div>';
    }
