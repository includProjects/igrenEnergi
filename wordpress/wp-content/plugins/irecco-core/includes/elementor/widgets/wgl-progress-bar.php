...
class Wgl_Progress_Bar extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Progress Bar', 'irecco-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('wgl_progress_bar_section',
            array(
                'label' => esc_html__('Progress Bar Settings', 'irecco-core'),
            )
        );
        ...
        $this->add_control('progress_title',
            array(
				...
				'default' => esc_html__('My Skill', 'irecco-core'),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('units',
            array(
                'label' => esc_html__('Units', 'irecco-core'),
                'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__('Enter your units', 'irecco-core'),
				'description' => esc_html__('Enter measurement units (Example: %, px, points, etc.)', 'irecco-core'),
        ...
        $this->add_control(
			'value_pos',
			[
				'label' => esc_html__('Value Position', 'irecco-core'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fixed' => esc_html__('Fixed', 'irecco-core'),
					'dynamic' => esc_html__('Dynamic', 'irecco-core'),
				],
				'default' => 'fixed',
			]
        );
        ...
        $this->start_controls_section(
            'bar_style_section',
            array(
                'label' => esc_html__('Progress Bar', 'irecco-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            )
        );
		...
		$this->add_control(
			'bar_height',
			[
				'label' => esc_html__('Progress Bar Height', 'irecco-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 1,
        ...
        $this->add_control(
            'bar_bg_color',
            array(
                'label' => esc_html__('Empty Bar Color', 'irecco-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
        ...
        $this->add_control(
            'bar_color',
            array(
                'label' => esc_html__('Filled Bar Color', 'irecco-core'),
                'type' => Controls_Manager::COLOR,
