...
class Wgl_Demo_Item extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Demo Item', 'irecco-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('wgl_demo_item_section',
            array(
                'label'         => esc_html__('Demo Item Settings', 'irecco-core'),
            )
        );
        ...
        $this->add_control('title_tag',
            array(
                ...
                'default'       => 'h3',
                'description'   => esc_html__('Choose your tag for demo item title', 'irecco-core'),
                'options'       => [
                    'h1'      => 'H1',
                    'h2'      => 'H2',
                    'h3'      => 'H3',
        ...
        $this->add_control('coming_soon',
            array(
                'label'        => esc_html__('Coming Soon', 'irecco-core'),
        ...
        $this->add_control('add_button',
            array(
                'label'        => esc_html__('Add Button', 'irecco-core'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('On', 'irecco-core'),
                'label_off'    => esc_html__('Off', 'irecco-core'),
                'return_value' => 'yes',
        ...
        $this->add_control('button_title',
            array(
                'label'         => esc_html__('Button Title', 'irecco-core'),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__('View Demo', 'irecco-core'),
                'condition'     => [
                    'add_button'   => 'yes',
                    'coming_soon'   => '',
                ]
        ...
        $this->add_control('demo_link',
            array(
                'label'             => esc_html__('Demo Link', 'irecco-core'),
        ...
        $this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__('Demo Item Styles', 'irecco-core'),
        ...
        $this->add_control(
            'coming_color',
            array(
                'label' => esc_html__('Coming Soon Color', 'irecco-core'),
                'type' => Controls_Manager::COLOR,
                'default' => $third_color,
                'separator' => 'before',
                'selectors' => array(
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('demo_button', 'class', [ 'wgl-button', 'elementor-button', 'elementor-size-xl' ]);
                ...
                if (!empty($settings[ 'thumbnail' ])) {?>
                    <div class="demo-item_image-wrap">
                        ...
                        if ((bool)$settings[ 'coming_soon' ]) {?>
                            <h5 class="demo-item_label"><?php echo esc_html__('Coming Soon', 'irecco-core' ); ?></h5><?php
                        }?>
                    </div><?php
                }
