...
class Wgl_Image_Layers extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Image Layers', 'irecco-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('wgl_image_layers_section',
            array(
                'label'         => esc_html__('General Settings', 'irecco-core'),
            )
        );
        ...
        $this->add_control(
            'interval',
            array(
                'label' => esc_html__('Enter Interval Images Appearing', 'irecco-core'),
                'type' => Controls_Manager::NUMBER,
                'min' => 50,
				'step' => 50,
				'default' => 600,
                'description' => esc_html__('Enter interval in milliseconds', 'irecco-core'),
            )
        );
        ...
        $this->add_control(
            'transition',
            array(
                'label' => esc_html__('Enter Transition Speed', 'irecco-core'),
                'type' => Controls_Manager::NUMBER,
                'min' => 50,
				'step' => 50,
				'default' => 800,
                'description' => esc_html__('Enter transition speed in milliseconds', 'irecco-core'),
            )
        );
        ...
        $this->add_control(
            'image_link',
            array(
                'label'             => esc_html__('Add Image Link', 'irecco-core'),
        ...
        $repeater->add_control(
            ...
            array(
				...
				'step' => 1,
				'default' => '0',
                'description' => esc_html__('Enter offset in %, for example -100% or 100%', 'irecco-core'),
            )
        );
        ...
        $repeater->add_control(
            'image_animation',
            array(
                'label' => esc_html__('Layer Animation', 'irecco-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'fade_in' => esc_html__('Fade In', 'irecco-core'),
                    'slide_up' => esc_html__('Slide Up', 'irecco-core'),
                    'slide_down' => esc_html__('Slide Down', 'irecco-core'),
                    'slide_left' => esc_html__('Slide Left', 'irecco-core'),
                    'slide_right' => esc_html__('Slide Right', 'irecco-core'),
                    'slide_big_up' => esc_html__('Slide Big Up', 'irecco-core'),
                    'slide_big_down' => esc_html__('Slide Big Down', 'irecco-core'),
                    'slide_big_left' => esc_html__('Slide Big Left', 'irecco-core'),
                    'slide_big_right' => esc_html__('Slide Big Right', 'irecco-core'),
                    'flip_x' => esc_html__('Flip Horizontally', 'irecco-core'),
                    'flip_y' => esc_html__('Flip Vertically', 'irecco-core'),
