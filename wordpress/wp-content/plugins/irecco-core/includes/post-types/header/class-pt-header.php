...
class Header
{
    ...
    {
        $this->name = __('Header Templates', 'irecco-core');
        $this->slug = 'header';
        $this->plural_name = __('Header Templates', 'irecco-core');
    ...
    public function register()
    {
        $labels = [
            ...
            'add_new' => sprintf(__('Add New Template', 'irecco-core'), $this->name),
            ...
            'all_items' => sprintf(__('All Templates', 'irecco-core'), $this->plural_name),
