...
class WGL_Posts_Hero extends WP_Widget {
    ...
    function __construct() {
        /* Widget settings. */
        $widget_ops = array('description' => esc_html__( 'Display posts with overlay image' , 'irecco-core' ) );

        /* Create the widget. */
        parent::__construct( 'postshero', esc_html__( 'WGL Posts Hero', 'irecco-core' ), $widget_ops );
    }
                    ...
                    <div class="recent-posts-content">
                        ...
                        <div class="recent-posts-content_wrapper">
                            ...
                            <?php if ( ( $show_cats == 'true' ) ) : ?>
                                <div class="post_cat">                         
                                    <?php
                                        echo iRecco_Theme_Helper::render_html($render_cats); 
                                    ?>                                 
                                </div> <!-- /entry-widget-date -->  
                            <?php endif; ?>
                        </div>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('show_cats')); ?>"><?php esc_html_e( 'Show categories' , 'irecco-core' ); ?></label>
        </p>        
        <p>
