	...
	class Wgl_Theme_Panel{
		...
		*/
		...
		public function theme_panel_admin_menu(){
			add_menu_page (
				esc_html__('WebGeniusLab', 'irecco'),
				esc_html__('WebGeniusLab', 'irecco'), 
			...
			$submenu = array();
			$submenu[] = array(
				esc_html__('Welcome', 'irecco'),    //page_title
				esc_html__('Welcome', 'irecco'),    //menu_title
				'manage_options',                               //capability
			...
			if (current_user_can( 'activate_plugins' )):
				$submenu[] = array(
					esc_html__('Theme Plugins', 'irecco'),   //page_title
					esc_html__('Theme Plugins', 'irecco'),   //menu_title
			...
			$submenu[] = array(
				esc_html__('Requirements', 'irecco'),   //page_title
				esc_html__('Requirements', 'irecco'),   //menu_title
				'edit_posts',                          //capability
			...
			$submenu[] = array(
				esc_html__('Activate Theme', 'irecco'),   //page_title
				esc_html__('Activate Theme', 'irecco'),   //menu_title
				'edit_posts',                           //capability
			...
			$submenu[] = array(
				esc_html__('Help Center', 'irecco'),   //page_title
				esc_html__('Help Center', 'irecco'),   //menu_title
				'edit_posts',                           //capability
			...
			if ( class_exists( 'iRecco_Core' ) ) {
				$submenu[] = array(
					esc_html__('Theme Options', 'irecco'),   //page_title
					esc_html__('Theme Options', 'irecco'),   //menu_title
					'edit_posts',                           //capability
