	...
	<a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
		<?php 		
			if(function_exists('aq_resize')){
				...
				echo iRecco_Theme_Helper::render_html($product->get_image()); // PHPCS:Ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
			}
		?>
		<span class="product-title"><?php echo iRecco_Theme_Helper::render_html( $product->get_name() ); ?></span>
	</a>

	<?php echo wc_get_rating_html( intval( get_comment_meta( $comment->comment_ID, 'rating', true ) ) );?>

	<span class="reviewer"><?php echo sprintf( esc_html__( 'by %s', 'irecco' ), get_comment_author( $comment->comment_ID ) ); ?></span>
