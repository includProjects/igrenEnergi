...
<div class="wrap wgl-wrap-status_panel">
	<table class="wgl-status-table_panel info_table widefat" cellspacing="0" style="margin-bottom: 30px;">
		<thead>
			<tr>
				<th colspan="4"><?php esc_html_e( 'Theme Config', 'irecco' ); ?></th>
			</tr>
		</thead>
		<tbody>
		    <tr>
		      <td><?php esc_html_e( 'Theme Name', 'irecco' ); ?>:</td>
		      <td><?php echo esc_html(wp_get_theme()->get('Name')); ?></td>
		    </tr>
		    <tr>
		      <td><?php esc_html_e( 'Version', 'irecco' ); ?>:</td>
		      <td><?php echo esc_html(wp_get_theme()->get('Version')); ?></td>
		    </tr>	    
		    <tr>
		      <td><?php esc_html_e( 'Author URL', 'irecco' ); ?>:</td>
		      <td>
	...
	<table class="wgl-status-table_panel info_table widefat" cellspacing="0" style="margin-bottom: 30px;">
		<thead>
			<tr>
				<th colspan="4"><?php esc_html_e( 'Server Settings', 'irecco' ); ?></th>
			</tr>
		</thead>
		<tbody>
		    <tr>
		      <td><?php esc_html_e( 'PHP Version', 'irecco' ); ?>:</td>
		      <td>
						...
						<span class="message_info message_info-error">
							<span class="dashicons dashicons-warning"></span>
								<?php
									...
									esc_html_e( '- We recommend a minimum PHP version of ', 'irecco');
		    ...
		    <tr>
		      <td><?php esc_html_e( 'PHP Post Max Size', 'irecco' ); ?>:</td>
		      <td>
		      		<span class="message_info message_info-info info">
						<span class="dashicons dashicons-warning"></span>
							<?php
								esc_html_e( ' You cannot upload images, themes and plugins that have a size bigger than this value: ', 'irecco');
							...
							<a target="_blank" href="http://www.wpbeginner.com/wp-tutorials/how-to-increase-the-maximum-file-upload-size-in-wordpress/">
								<?php
								esc_html_e( ' To see how you can change this please check this guide', 'irecco');
								?>	
							</a>
					</span>
		    ...
		    <tr>
		      <td><?php esc_html_e( 'PHP Max Execution Time Limit', 'irecco' ); ?>:</td>
		      <td>
		      	...
		      	if ( $max_execution_time_requirements > ini_get('max_execution_time') ) {
		      		...
		      		<span class="message_info message_info-error">
		      			...
		      			<?php
		      				...
		      				esc_html_e( '- We recommend setting max execution time to at least ', 'irecco');
		    ...
		    <tr>
		      <td><?php esc_html_e( 'PHP Max Input Time', 'irecco' ); ?>:</td>
		      <td>
		      	...
		      	if ( $max_input_time_requirements > ini_get('max_input_time') ) {
		      		...
		      		<span class="message_info message_info-error">
		      			...
		      			<?php
		      				...
		      				esc_html_e('- We recommend setting max input time to at least ', 'irecco');
		    ...
		    <tr>
		      <td><?php esc_html_e( 'PHP Max Input Vars', 'irecco' ); ?>:</td>
		      <td>
		      	<?php
		      	...
		      	if ( $max_input_vars_requirements > ini_get('max_input_vars') ) {
		      		...
		      		<span class="message_info message_info-error">
		      			...
		      			<?php
		      				...
		      				echo sprintf( esc_html__( '. We recommend minimum value: %d. Max input vars limitation will truncate POST data such as menus.' , 'irecco' ) ,$max_input_vars_requirements );
		      			?>
		      			<br/>
		    ...
		    <tr>
		      <td><?php esc_html_e( 'MySql Version', 'irecco' ); ?>:</td>
		      <td><?php echo (!empty( $wpdb->is_mysql ) ? $wpdb->db_version() : ''); ?></td>
		    </tr>		    
		    <tr>
		      <td><?php esc_html_e( 'Max upload size', 'irecco' ); ?>:</td>
		      <td>
		      	<?php
		      		...
		      		?>
			      		<span class="message_info message_info-error">
			      			...
			      			<?php
			      				...
			      				esc_html_e( '. We recommend minimum value: 128 MB.' , 'irecco')
			      			?>
			      			<br/>
			      			<a target="_blank" href="https://premium.wpmudev.org/forums/topic/increase-wp-memory-limit-php-max-input-vars/">
			      				<?php
	...
	<table class="wgl-status-table_panel info_table widefat" cellspacing="0" style="margin-bottom: 30px;">
		<thead>
			<tr>
				<th colspan="4"><?php esc_html_e( 'WordPress Settings', 'irecco' ); ?></th>
			</tr>
		</thead>
		<tbody>
		    <tr>
		      <td><?php esc_html_e( 'Home Url', 'irecco' ); ?>:</td>
		      <td><?php echo esc_html(home_url( '/' )); ?></td>
		    </tr>		   
		     <tr>
		      <td><?php esc_html_e( 'Site Url', 'irecco' ); ?>:</td>
		    ...
		    <tr>
		      <td><?php esc_html_e( 'Memory Limit', 'irecco' ); ?>:</td>
		      <td>		      	
		      	<?php
		      	...
		      	if ( $memory_limit_requirements > Wgl_Status_Info_Helper()->memory_limit() ) {
		      		...
		      		<span class="message_info message_info-error">
		      			...
		      			<?php
		      				...
		      				esc_html_e( ' .We recommend setting memory to be at least 128MB.' , 'irecco')
		      			?>
		      			<br/>
		    ...
		    <tr>
		    	...
		    	<td>	
		    		...
		    		?>
			    		<?php echo esc_html__('WP_DEBUG is enabled.','irecco');?>
			    		<a target="_blank" href="https://codex.wordpress.org/Debugging_in_WordPress">		<?php echo esc_html__(' How to disable WP_DEBUG mode.','irecco');?>
			    		</a>
		    		<?php else: ?>
		    			<?php echo esc_html__('WP_DEBUG is disabled.','irecco');?>
		    		<?php endif; ?>
		    	</td>
		    </tr>
		  </tbody>
