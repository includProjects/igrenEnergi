...
class Wgl_Section{
    ...
    public function add_hooks() {
        ...
        add_action('elementor/element/post/document_settings/after_section_end', [ $this, 'post_metaboxes' ] , 10 , 1 );
    }
    ...
    function post_metaboxes( $page ) {
        ...
        $page->start_controls_section(
            'header_options',
            array(
                'label'     => esc_html__( 'WGL Header Options', 'irecco-core' ),
        ...
        $page->add_control(
            'mobile_breakpoint',
            array(
                'label' => esc_html__( 'Mobile Header resolution breakpoint', 'irecco-core' ),
        ...
        $page->add_control(
            'header_on_bg',
            array(
                'label'        => esc_html__('Over content?','irecco-core' ),
                'description' => esc_html__( 'Set Header to display over content.', 'irecco-core' ),
    ...
    public function extened_animation( $widget, $args ){
        $widget->start_controls_section(
            'extened_animation',
            array(
                'label'     => esc_html__( 'WGL Background Text', 'irecco-core' ),
        ...
        $widget->add_control(
            'add_background_text',
            array(
                'label'        => esc_html__('Add Background Text?','irecco-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'irecco-core' ),
                'label_off'    => esc_html__( 'Off', 'irecco-core' ),
        ...
        $widget->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Top Spacing', 'irecco-core' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $widget->add_control(
            ...
            array(
                'label'        => esc_html__('Apply Animation?','irecco-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'irecco-core' ),
                'label_off'    => esc_html__( 'Off', 'irecco-core' ),
        ...
        $widget->start_controls_section(
            'extened_parallax',
            array(
                'label'     => esc_html__( 'WGL Parallax', 'irecco-core' ),
                'tab'       => Controls_Manager::TAB_STYLE
            )
        );
        ...
        $widget->add_control(
            ...
            array(
                'label'        => esc_html__('Add Extended Background Animation?','irecco-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'irecco-core' ),
                'label_off'    => esc_html__( 'Off', 'irecco-core' ),
                'return_value' => 'yes',
        ...
        $repeater->add_control('image_effect',
            array(
                'label'             => esc_html__('Parallax Effect', 'irecco-core'),
                'type'              => Controls_Manager::SELECT,
                'options'           => [
                    'scroll'        => esc_html__('Scroll', 'irecco-core'),
                    'mouse'         => esc_html__('Mouse', 'irecco-core'),  
                    'css_animation' => esc_html__('CSS Animation', 'irecco-core'),  
                ],
                'default' => 'scroll',
            )
        ); 
        ...
        $repeater->add_responsive_control(
            'animation_name',
            array(
                'label' => esc_html__( 'Animation', 'irecco-core' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Animation Iteration Count', 'irecco-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => '1',
                'options' => [
                    'infinite' => esc_html__( 'Infinite', 'irecco-core' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Animation Direction', 'irecco-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
                'options' => [
                    'normal' => esc_html__( 'Normal', 'irecco-core' ),
                    'reverse' => esc_html__( 'Reverse', 'irecco-core' ),
                    'alternate' => esc_html__( 'Alternate', 'irecco-core' ),
                ],
                'condition' => [
                    'image_effect' => 'css_animation',
                ],
        ...
        $repeater->add_control(
            'image_bg',
            array(
                'label' => esc_html__( 'Parallax Image', 'irecco-core' ),
        ...
        $repeater->add_control('parallax_dir',
            array(
                'label' => esc_html__('Parallax Direction', 'irecco-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'vertical'  => esc_html__('Vertical', 'irecco-core'),
                    'horizontal' => esc_html__('Horizontal', 'irecco-core'), 
                ],
                'condition' => [
                    'image_effect' => 'scroll',
                ],
        ...
        $repeater->add_control(
            'parallax_factor',
            array(
                'label' => esc_html__( 'Parallax Factor', 'irecco-core' ),
                'type' => Controls_Manager::NUMBER,
                'min' => -3,
                'max' => 3,
                'step' => 0.01,
                'default' => 0.03,
                'description' => esc_html__( 'Set elements offset and speed. It can be positive (0.3) or negative (-0.3). Less means slower.', 'irecco-core' ),
            )
        );    
        ...
        $repeater->add_responsive_control(
            ...
            [
                ...
                'default' => [ 'size' => 0, 'unit' => '%' ],
                'description' => esc_html__( 'Set figure vertical offset from top border.', 'irecco-core' ),
                'selectors' => [
        ...
        $repeater->add_responsive_control(
            'position_left',
            [
                'label' => esc_html__( 'Left Offset', 'irecco-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%', 'px'  ],
                'range' => [
                    '%' => [
                ...
                'description' => esc_html__( 'Set figure horizontal offset from left border.', 'irecco-core' ),
                'selectors' => [
        ...
        $repeater->add_control(
            'image_index',
            array(
                'label' => esc_html__( 'Image z-index', 'irecco-core' ),
                'type' => Controls_Manager::NUMBER,
                'step' => 1,
                'default' => -1,
                'selectors' => [
        ...
        $repeater->add_control(
            'hide_on_mobile',
            array(
                'label'        => esc_html__('Hide On Mobile?','irecco-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'irecco-core' ),
                'label_off'    => esc_html__( 'Off', 'irecco-core' ),
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            ...
            array(
                'label' => esc_html__( 'Screen Resolution', 'irecco-core' ),
                'type' => Controls_Manager::NUMBER,
                'step' => 1,
                'default' => 768,
                'condition' => [
        ...
        $widget->start_controls_section(
            'extened_shape',
            array(
                'label'     => esc_html__( 'WGL Shape Divider', 'irecco-core' ),
                'tab'       => Controls_Manager::TAB_STYLE
            )
        );
        ...
        $shapes_options = [
            ...
            'torn_line' => esc_html__( 'Torn Line', 'irecco-core' ),
        ];
        ...
        foreach ( [
            ...
            $widget->add_control(
                ...
                array(
                    'label' => esc_html__( 'Z-index', 'irecco-core' ),
                    'type' => Controls_Manager::NUMBER,
                    'step' => 1,
                    'default' => 0,
                    'selectors' => [
    ...
    public function extends_header_params($widget, $args) {
        ...
        $widget->start_controls_section(
            'extened_header',
            array(
                'label'     => esc_html__( 'WGL Header Layout', 'irecco-core' ),
        ...
        $widget->add_control(
            'apply_sticky_row',
            array(
                'label'        => esc_html__('Apply Sticky?','irecco-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'irecco-core' ),
                'label_off'    => esc_html__( 'Off', 'irecco-core' ),
    ...
    public function extends_column_params($widget, $args) {
        ...
        $widget->start_controls_section(
            'extened_header',
            array(
                'label'     => esc_html__( 'WGL Column Options', 'irecco-core' ),
                'tab'       => Controls_Manager::TAB_LAYOUT
            )
        );
        ...
        $widget->add_control(
            'apply_sticky_column',
            array(
                'label'        => esc_html__('Enable Sticky?','irecco-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'On', 'irecco-core' ),
                'label_off'    => esc_html__( 'Off', 'irecco-core' ),
