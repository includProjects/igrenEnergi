...
class Wgl_Working_Hours extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Working Hours', 'irecco-core');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'default' => esc_html__('Monday', 'irecco-core'),
            )
        );
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('8.00 - 21.00', 'irecco-core'),
            )
        );
        ...
        $repeater->add_control(
            'custom_colors',
            array(
                'label' => esc_html__('Custom Colors', 'irecco-core'),
        ...
        $repeater->add_control(
            'day_color',
            array(
                'label' => esc_html__('Day Color', 'irecco-core'),
        ...
        $repeater->add_control(
            'hours_color',
            array(
                'label' => esc_html__('Hours Color', 'irecco-core'),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'items',
            array(
                'label' => esc_html__('Days', 'irecco-core'),
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    [ 'working_day' => esc_html__('Monday', 'irecco-core')],
                    [ 'working_day' => esc_html__('Tuesday', 'irecco-core')],
                ],
        ...
        $this->start_controls_section(
            'style_section',
            array(
                'label' => esc_html__('Styles', 'irecco-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Item Styles', 'irecco-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Day Styles', 'irecco-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Hours Styles', 'irecco-core'),
            ]
        );
        ...
        $this->add_control(
            'line_color',
            array(
                'label' => esc_html__('Line Between Color', 'irecco-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '#e5e5e5',
                'selectors' => array(
