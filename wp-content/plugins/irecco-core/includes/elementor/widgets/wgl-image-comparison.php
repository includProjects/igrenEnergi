...
class Wgl_Image_Comparison extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Image Comparison', 'irecco-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('wgl_image_comparison_section',
            array(
                'label' => esc_html__('Image Comparison Settings', 'irecco-core'),
            )
        );
        ...
        $this->add_control(
            'before_image',
            array(
                'label' => esc_html__('Before Image', 'irecco-core'),
        ...
        $this->add_control(
            'after_image',
            array(
                'label' => esc_html__('After Image', 'irecco-core'),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
        ...
        $this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__('Slider Bar Styles', 'irecco-core'),
        ...
        $this->add_control(
			'slider',
			[
				'label' => esc_html__('Slider Bar', 'irecco-core'),
