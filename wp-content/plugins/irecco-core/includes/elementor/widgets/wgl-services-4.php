...
class Wgl_Services_4 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Services 4', 'irecco-core');
    }
    ...
    protected function _register_controls() {
        ...
        Wgl_Icons::init( $this, array( 'label' => esc_html__('Services 4 ', 'irecco-core'), 'output' => '','section' => true, 'prefix' => '' ) );
        ...
        $repeater->add_control(
            'text_link',
            array(
                'label' => esc_html__('Link Text', 'irecco-core'),
        ...
        $this->add_control(
            'items',
            array(
                'label' => esc_html__('Links', 'irecco-core'),
